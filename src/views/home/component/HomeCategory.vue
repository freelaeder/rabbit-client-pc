...
<template>
    <div class="home-category">
      <ul class="menu">
        ...
        <template v-else>
            <li v-for="leftcategory in categories.homeCategory" :key="leftcategory.id">
          <RouterLink :to="`/category/${leftcategory.id}`">{{leftcategory.name}}</RouterLink>
          <RouterLink  :to="`/category/sub/${leftcategory.id}/${subCategory.id}`"
          v-for="subCategory in leftcategory.children">{{subCategory.name}}</RouterLink>
          ...
          <div class="layer">
            ...
            <ul>
              <li v-for="goods in leftcategory.goods" :key="goods.id">
                <RouterLink to="/">
